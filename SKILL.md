...
3. **强基计划**：按[全国路径比较](references/pathway-comparison.md)搜索面向生源省的全国学校，先列冲1所、稳1所、保1所及同档备选，再说明参考分数为什么可以考虑该路径、是什么与怎样培养，最后说明基础学科兴趣、选科与准备代价。兴趣暂未验证不能提前删空学校；普通批线只作能力参照，不能当强基入围线。
