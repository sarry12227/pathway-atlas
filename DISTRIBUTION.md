...
main 的 `0.1.2` 增加对话中完整交付结论的规则和 `finish.report_text`，保留 `0.1.1` 的逐题引导。下表逐行记录各平台最近一次单独核验的版本；条目已收录不表示该平台已更新到 main 最新版。腾讯后续更新包使用平台版本 `1.0.3`，对应主源 `0.1.2`，需要所有者在已有条目中上传。
...
| ClawHub | https://clawhub.ai | Official CLI registry publish | v0.1.1 / ffd6d1d | submitted | — | 2026-09-07 | 官方 dry-run 返回 unchanged、latestVersion 0.1.1，178 个文件的指纹与提交包一致；本次未将公共下载状态视为已验证。已获版权所有者对 ClawHub 的额外 MIT-0 授权。 |
